...
public class CorrespondenceDocumentLookupSuggestion extends  Suggestion {
  ...
  //  private static final String DMS_FOLDER_DOCUMENT_TYPE_CODE_PROPERTY = "dmsfolder:documentTypeCode" ;
    ...
    public CorrespondenceDocumentLookupSuggestion(String id, DocumentLocation documentLocation, String type, String typeLabel, Boolean isFolder, String label, String iconURL, String mimetype, String referenceNumber) {
    ...
    public static Suggestion fromDocumentModel(DocumentModel doc) {
        ...
        String refNumber = doc.getProperty("corr:referenceNumber").getValue(String.class);
        String icon = null;
...
//        }
        ...
        return new CorrespondenceDocumentLookupSuggestion(doc.getId(),new DocumentLocationImpl(doc), typeInfo.getId(),typeInfo.getLabel(),doc.isFolder(), doc.getTitle(), icon,mimetype,refNumber).withDescription(
