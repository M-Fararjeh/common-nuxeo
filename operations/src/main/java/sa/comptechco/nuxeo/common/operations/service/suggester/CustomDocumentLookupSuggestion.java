...
public class CustomDocumentLookupSuggestion extends  Suggestion {
    ...
    public CustomDocumentLookupSuggestion(String id, DocumentLocation documentLocation, String type, String typeLabel, Boolean isFolder, String label, String superType, String documentTypeCode, String iconURL, String mimetype) {
    ...
    public static Suggestion fromDocumentModel(DocumentModel doc) {
        ...
        else if(doc.getDocumentType().getName().equals(DMS_FOLDER)||doc.getDocumentType().getSuperType().getName().equals(DMS_FOLDER))
        {
            ...
            documentTypeCode = doc.getDocumentType().getName();
        }


        return new CustomDocumentLookupSuggestion(doc.getId(), new DocumentLocationImpl(doc),typeInfo.getId(),typeInfo.getLabel(),doc.isFolder(), doc.getTitle(),superType,documentTypeCode, icon,mimetype).withDescription(
